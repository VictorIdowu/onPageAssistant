...
function App() {
  ...
  return (
    <section className="w-full">
      ...
      <aside className="absolute top-1/2 left-0 -translate-y-1/2 grid grid-rows-2 md:grid-cols-2  gap-3">
      ...
      <div
        ...
        className={`flex flex-col items-center sm:text-start  rounded-[50%] absolute left-5 bottom-5 ease-in duration-1000`}
      >
        <Icon
          className="text-6xl sm:text-8xl"
          icon="fluent-emoji-flat:girl-medium"
        />
        <p className="bg-green-400 text-gray-100 px-3 rounded-3xl type">
          {msg}
        </p>
      </div>
    </section>
